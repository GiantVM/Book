...
2026-01-13：原书36页图2-6中VMCS模块中的“客户机状态域”字段，应改为宿主机状态域，因为其对应的箭头指向的是宿主机hyperviosr的寄存器状态。本勘误由西南交通大学计算机与人工智能学院研究生唐世涛同学指出。

2026-05-08：一批新的勘误得到了确认并将会在下次出版中进行修改，详细勘误内容在.[corrections26.pdf](./corrections26.pdf)中。本次勘误由西南交通大学计算机与人工智能学院研究生唐世涛同学指出。
